...
describe("handleGetBookByTitle", () => {
    ...
    it("should return book data when title is valid and books are found", async () => {
        ...
        const result = await handleGetBookByTitle({ title: "Test Book" }, mockAxiosInstance);
    ...
    it("should handle book with missing optional fields", async () => {
        ...
        mockAxiosInstance.get.mockResolvedValue({ data: mockResponseData });
        const result = await handleGetBookByTitle({ title: "Minimal Book" }, mockAxiosInstance);
    ...
    it("should return appropriate message when no books are found", async () => {
        ...
        const result = await handleGetBookByTitle({ title: "Nonexistent Book" }, mockAxiosInstance);
        expect(result).toEqual({
            content: [
                {
                    type: "text",
    ...
    it("should throw McpError for invalid arguments", async () => {
        ...
        await expect(async () => {
            await handleGetBookByTitle({ wrongParam: "something" }, mockAxiosInstance);
        }).rejects.toThrow(McpError);
        await expect(async () => {
